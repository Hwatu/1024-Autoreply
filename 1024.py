...
class Autoreply:
    ...
    def getreply():
        #自定义回复内容，记得修改随机数
        reply=['感谢分享','感谢你的分享','谢谢分享','多谢分享','感谢作者的分享','谢谢坛友分享','内容精彩','[size=5][b][color=#FFFFFF][backcolor=#000000]感谢分享[/backcolor][/color][backcolor=#FF9900]勿忘提肛[/backcolor][/b][/size]','感谢分享','涨知识了','很有意思']
    ...
    def main(cookieslist,todaylist,ge):
        ...
        while n<10 and suc is False:
            try:
                ...
                sleeptime=random.randint(1024,1248)
